...
def cal_insumos_soja(area_util, densidade):
    ...
    nitrogenio = 0.001  # kg/m² (convertido de 1g)
    herbicida = 0.01  # L/m²
    fungicida = 0.01  # L/m²
    inseticida = 0.005  # L/m²
    agua = 4  # L/m²/dia
    ...
    return {
        ...
        "Herbicida": f"{formatar_numero(herbicida * area_util)} L",
        "Fungicida": f"{formatar_numero(fungicida * area_util)} L",
        "Inseticida": f"{formatar_numero(inseticida * area_util)} L",
